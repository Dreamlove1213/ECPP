...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a onclick="javascript:Foo();return false;" href="#">历史信息列表</a></li>
		<%-- <shiro:hasPermission name="ecpp:information:edit"><li><a href="${ctx}/ecpp/information/form">信息添加</a></li></shiro:hasPermission> --%>
	</ul>
	<form:form id="searchForm" modelAttribute="information" action="${ctx}/ecpp/information/hositoryList" method="post" class="breadcrumb form-search">
