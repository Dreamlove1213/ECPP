...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a onclick="javascript:Foo();return false;" href="#">部门信息列表</a></li>
		<%-- <shiro:hasPermission name="ecpp:information:edit"><li><a href="${ctx}/ecpp/information/form">信息添加</a></li></shiro:hasPermission> --%>
	</ul>
	<form:form id="searchForm" modelAttribute="information" action="${ctx}/ecpp/information/list2" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="information" varStatus="i">
			<tr>
				...
				<c:if test="${isAllowDel == true}">
				<td style="text-align:center">
					<a href="${ctx}/ecpp/information/delete?id=${information.id}" onclick="return confirmx('确认要删除该条信息吗？', this.href)">
						删除
					</a>
				</td>
				</c:if>
