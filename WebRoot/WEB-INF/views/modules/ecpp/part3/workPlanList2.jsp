...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ecpp/planinformation/a3ListWorkPlan?unit.id=${officeId}">工作计划列表</a></li>
		<li><a href="${ctx}/ecpp/planinformation/a3List2?unit.id=${ecppWorkprogramme.unit.id}&unit.type=${ecppWorkprogramme.unit.type}">目标列表</a></li>
	</ul>
