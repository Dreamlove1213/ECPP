...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ecpp/planinformation/a3ListWorkPlanCompany?unit.id=${officeId}">工作计划列表</a></li>
		<li><a href="${ctx}/ecpp/planinformation/a3List1?remarks=${officeId}">目标列表</a></li>
	</ul>
