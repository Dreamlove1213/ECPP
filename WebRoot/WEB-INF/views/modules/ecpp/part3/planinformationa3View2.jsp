...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/ecpp/planinformation/a3List2?unit.id=${planinformation.unit.id}&unit.type=${planinformation.unit.type}">目标列表</a></li>
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<script type="text/template" id="improvementsTpl">//<!--
						...
						<c:if test="${todo ne 'a2'}">
						<tr>
							<td colspan="6"><font style="color:black;">实施历史：</font>
								<input class="rowdata" type="hidden" name="da_{{row.id}}" value="{{row.attribute2}}"/>
								<p id="da_{{row.id}}" style="width:89%;margin-left: 15px;line-height: 20px;"></p>
							</td>
						</tr>
