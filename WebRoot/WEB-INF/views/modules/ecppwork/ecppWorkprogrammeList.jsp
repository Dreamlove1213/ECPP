...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a onclick="javascript:Foo();return false;" href="#">工作计划列表</a></li>
		<%-- <shiro:hasPermission name="ecppwork:ecppWorkprogramme:edit"><li><a href="${ctx}/ecppwork/ecppWorkprogramme/form">工作计划添加</a></li></shiro:hasPermission> --%>
	</ul>
		...
		<c:forEach items="${page.list}" var="ecppWorkprogramme" varStatus="i">
			<tr>
				...
				<shiro:hasPermission name="ecppwork:ecppWorkprogramme:edit"><td style="text-align:center;vertical-align:middle;">
					...
					<a href="${ctx}/ecppwork/ecppWorkprogramme/delete?id=${ecppWorkprogramme.id}" onclick="return confirmx('确认要删除该工作计划吗？', this.href)">删除</a>
