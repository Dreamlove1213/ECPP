...
<head>
    ...
    <Meta http-equiv="Refresh" Content="0; Url=http://172.18.102.99/oa">
	<meta name="decorator" content="loginNew"/>
	<link rel="shortcut icon" type="image/x-icon" href="${ctxStatic}/indexStyle/img/favicon.ico" />
<!-- 	<style type="text/css">
...
<%-- 	<div class="header">
	...
	<div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v" id="loginPageBg">

      <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
        <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">管理提升信息系統</div>
        <div class="tx-center mg-b-60"></div>
        <div id="messageBox" style="display:none;" class="alert alert-error ${empty message ? 'hide' : ''}"><button data-dismiss="alert" class="close">×</button>
			<label id="loginError" class="error">${message}</label>
		</div>
