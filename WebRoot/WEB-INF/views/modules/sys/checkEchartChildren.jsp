...
<script type="text/javascript">
    ...
    option = {
            ...
            xAxis: {
                //data: ["设计与工程总包","煤机设备","安全技术与装备","示范工程","节能环保","新兴产业"]
            	data:data1
            },
            yAxis: {
                type: 'value',
   ...
   myChart.on('click', function (param) {
	 parent.location.href="${ctx}/ecpp/planinformation/a3ListIndexLook?unit.plate="+option.series[0].dataClick[param.dataIndex]+"&unit.type=3&target='mainFrame'";
