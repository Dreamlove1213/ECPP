...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="user">
			<tr>
				<td class="alignCenter">${user.company.name}</td>
				<td class="alignCenter">${user.office.name}</td>
				<%-- <td class="alignCenter"><a href="${ctx}/sys/user/form?id=${user.id}">${user.loginName}</a></td> --%>
				<td class="alignCenter">${user.loginName}</td>
				<td class="alignCenter">${user.name}</td>
				<td class="alignCenter">${user.phone}</td>
				<td class="alignCenter">${user.mobile}</td><%--
				<td>${user.roleNames}</td> --%>
				<shiro:hasPermission name="sys:user:edit"><td class="alignCenter">
				<%--<c:if test="${user.loginName!='YOUKE'}">--%>
