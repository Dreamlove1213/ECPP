	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div id="plate">
			<div class="control-group">
				...
				<div class="controls">
					<form:checkboxes path="plateList" items="${fns:getDictList('ecpp_plate_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					
					<%--<form:checkboxes path="roleIdList" items="${allRoles}" itemLabel="name" itemValue="id" htmlEscape="false" class="required"/>
					 <form:select id="plateVal" path="plate" class="input-medium required">
						<form:options items="${fns:getDictList('ecpp_plate_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					</form:select> --%>
					<span class="help-inline"><font color="red">*</font> </span>
				</div>
			</div>
