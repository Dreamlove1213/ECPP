...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/stion/strformation/">新建机构列表</a></li>
		<li class="active"><a href="${ctx}/stion/strformation/form?id=${strformation.id}">新建机构<shiro:hasPermission name="stion:strformation:edit">${not empty strformation.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="stion:strformation:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="strformation" action="${ctx}/stion/strformation/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="dianhua" htmlEscape="false" maxlength="255" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="control-group">
				<label class="control-label">组建机构子表：</label>
				<div class="controls">
					...
					<script type="text/template" id="strformationitemTpl">//<!--
						<tr id="strformationitemList{{idx}}">
							...
							<td>
								<input id="strformationitemList{{idx}}_nane" name="strformationitemList[{{idx}}].nane" type="text" value="{{row.nane}}" maxlength="255" class="input-small "/>
							</td>
							<td>
							...
							<td>
								<input id="strformationitemList{{idx}}_youxiang" name="strformationitemList[{{idx}}].youxiang" type="text" value="{{row.youxiang}}" maxlength="255" class="input-small "/>
							</td>
		...
		<div class="form-actions">
			<shiro:hasPermission name="stion:strformation:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
