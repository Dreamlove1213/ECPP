 ...
 * @version 2018-03-29
 */
public class EcppWorkprogramme extends DataEntity<EcppWorkprogramme> {
	...
	public EcppWorkprogramme() {
		super();
	}

	public EcppWorkprogramme(String id){
		super(id);
	}
