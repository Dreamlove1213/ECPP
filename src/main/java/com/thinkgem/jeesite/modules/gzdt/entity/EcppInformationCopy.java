 ...
 * @version 2018-04-03
 */
public class EcppInformationCopy extends DataEntity<EcppInformationCopy> {
	...
	public EcppInformationCopy() {
		super();
	}

	public EcppInformationCopy(String id){
		super(id);
	}
	...
	@Length(min=0, max=1500000, message="信息内容长度必须介于 0 和 1500000 之间")
